...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv = findViewById(R.id.txtBookAppointment);
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (db.checkAppointmentExist(username, title +"=>"+fullName,address,contact,
                    ...
                    db.addOrder(username, title+" => "+fullName,address,contact,"0",dateButton.getText().toString(),timeButton.getText().toString(),fees,"doctor appointment");
                Toast.makeText(getApplicationContext(),"Your Appointment done Successfully", Toast.LENGTH_SHORT).show();
